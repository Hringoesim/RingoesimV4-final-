...
serve(async (req) => {
  ...
  try {
    console.log('Waitlist email function called');
    ...
    console.log('Using Resend API key from secrets');
    ...
    const notificationSubject = 'New Waitlist Signup - Ringo';
    ...
    console.error('Error in waitlist email function:', error);
    return new Response(
      JSON.stringify({ 
